...
public class MainExB {
	...
	public static void main(String[] args) {
		 ...
		 * 클래스의 객체가 실행될때 다른 클래스의 객체를 연결하여 사용해야 하는 경우
		 * 보통은 각 클래스에서 다른 클래스의 객체를 생성하여 사용하는데,
		 * 그러한 코드는 결합도가 매우 높아진다
		 * 하지만 인터페이스를 매개변수로 하고 , 생성자를 생성된 객체를
		 * 주입하면 결합도를 매우 낮출 수 있다
		 * 
		 * 소프트웨어공학에서 디자인 패턴 14가지가 있는데
		 * 그중 전략패턴을 적용한것
		 * 
		 * 
		 * 
